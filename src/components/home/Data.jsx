...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">João Augusto
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                <p className="home__description">I'm a Front End and Back End Junior developer, graduated in Business Administration and postgraduate in Technology for Web Applications, currently working as a freelancer.</p>
