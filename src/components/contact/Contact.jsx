            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+55 24 998730714</span>

                        <a href=" https://wa.me/5524998730714?text=Hello, I can help you" className="contact__button">Write me{""}<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    <div className="contact__form-div">
                        ...
                        type="text" 
                        name="name"
                        className="text name contact__form-input" placeholder='Insert your name' required />
                    </div>
                    ...
                    <div className="contact__form-div">
                        ...
                        type="email" 
                        name="email"
                        className="text name contact__form-input" placeholder='Insert your email' required/>
                    </div>
